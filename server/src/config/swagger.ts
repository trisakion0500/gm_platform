      ...
      schemas: {
        ...
        Company: {
          ...
          properties: {
            ...
            company_code: { type: 'string',  pattern: '^[a-zA-Z0-9_.-]+$', maxLength: 20, example: 'COMPANY_A' },
        ...
        Project: {
          ...
          properties: {
            ...
            company_code: { type: 'string',  pattern: '^[a-zA-Z0-9_.-]+$', maxLength: 20, example: 'COMPANY_A' },
            company_name: { type: 'string',  maxLength: 100, example: '회사A' },
            project_code: { type: 'string',  pattern: '^[a-zA-Z0-9_.-]+$', maxLength: 20, example: 'PROJECT_A' },
        ...
        User: {
          ...
          properties: {
            ...
            phone_number:         { type: 'string',  maxLength: 20, example: '010-1234-5678', description: '서버에 AES-256-CBC로 암호화되어 저장됨' },
            department:           { type: 'string',  nullable: true, maxLength: 100, example: '개발팀' },
            position:             { type: 'string',  nullable: true, maxLength: 100, example: '사원' },
        ...
        LogAudit: {
          ...
          properties: {
            ...
            project_name: { type: 'string',  nullable: true, example: null, description: 'project_id가 null이면 null' },
            ...
            created_by_name: { type: 'string', nullable: true, example: 'sa', description: '작업 수행 사용자 이름' },
